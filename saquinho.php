...
<head>
    ...
    <link rel="stylesheet" href="css/style-entrar-cadastrar.css">
</head>
    ...
    <div class="compras">
        ...
        <div class="container_compra">
            ...
            <script>
                ...
                <button type="button" onclick=" localStorage.clear(); location.reload();"> Limpar carrinho 
                <br>
                <button type="button" onclick=" localStorage.clear(); location.reload();"> Pagar compra </button>
                </button>
